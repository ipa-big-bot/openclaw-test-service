...
**Status:** DONE
**Commits:** `b342545` - task-6: document and verify current weather endpoint

### Completed Steps:
1. README.md already contains Current Weather API documentation with:
...
2. Verified no blocking production calls (grep search passed)
3. Maven verify passes (77 tests: 57 unit + 10 integration)
4. Repository hygiene clean (git status --short shows nothing)
