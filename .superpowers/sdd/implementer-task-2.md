You are implementing Task 2 from the Spring Boot Service Scaffold plan at `docs/superpowers/plans/2026-09-10-spring-boot-service-scaffold.md`.
...
Add Actuator Health Endpoints to the Spring Boot Service.

### Files to Create/Modify:
1. Modify `pom.xml` (add Actuator dependency)
2. Create `src/main/resources/application.yml` (Actuator configuration)
3. Create `src/test/java/de/fraunhofer/ipa/openclawtestservice/HealthEndpointIT.java` (Integration test)
...
### Your Work:
1. Read the task brief at `/home/openclaw/openclaw-test-service/.superpowers/sdd/task-2-brief.md` - this is your exact requirement source
2. Implement all required files
3. Run tests with `./mvnw --batch-mode verify`
4. Write your report to `/home/openclaw/openclaw-test-service/.superpowers/sdd/task-2-report.md` with:
